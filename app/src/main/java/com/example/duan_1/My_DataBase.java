...
public class My_DataBase extends SQLiteOpenHelper {
    ...
    public ArrayList<Model_question> getData(){
        createDataBase();
        openDataBase();
        ArrayList<Model_question> arrQuestions=new ArrayList<>();
        for (int i=1;i<16;i++) {
            ...
            Model_question question1=new Model_question(id,question,caseA,caseB,caseC,caseD,trueCase);
